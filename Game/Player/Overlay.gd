...
# var a = 2
# var b = "text"
onready var Item1 = $Screen/Top/Item1/Ammount
onready var Item2 = $Screen/Top/Item2/Ammount
onready var Level = $Screen/Top/Level/Ammount
onready var Followers = $Screen/Top/Followers/Ammount
